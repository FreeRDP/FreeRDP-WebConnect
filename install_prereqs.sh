	...
	CentOS*6*)
		...
		if [[ $response_install == 'y' ]]; then
			if [[ $(uname -m) == 'x86_64' ]]; then
				...
				wget ftp://rpmfind.net/linux/centos/6.4/os/i386/Packages/autoconf-2.63-5.1.el6.noarch.rpm && yum install -y autoconf-2.63-5.1.el6.noarch.rpm
				rm -f autoconf-2.63-5.1.el6.noarch.rpm
			fi
		fi
		...
		if [[ $response_install == 'y' ]]; then
			if [[ $(uname -m) == 'x86_64' ]]; then
				...
				wget ftp://rpmfind.net/linux/centos/6.4/os/i386/Packages/automake-1.11.1-4.el6.noarch.rpm && yum install -y automake-1.11.1-4.el6.noarch.rpm
				rm -f automake-1.11.1-4.el6.noarch.rpm
			fi
		fi	
		...
		if [[ $response_install == 'y' ]]; then
			if [[ $(uname -m) == 'x86_64' ]]; then
				...
				wget ftp://rpmfind.net/linux/centos/6.4/os/i386/Packages/libtool-2.2.6-15.5.el6.i686.rpm && yum install -y libtool-2.2.6-15.5.el6.i686.rpm
